...
store = 's'
def name ():
        usrName = input('What is your Name? ') #function
        return(usrName)
usrName = name()
...
mensClothes3 = {'Anything is possible Tshirt':19.99 , 'Mens Summer games Cargo pant':40.00 , 'Nordstorm Trim fit Dress shirt':59.50 , 'Brown Jacket':100.00 , 'Nike Sportswear Fullzip hoodie':130.00 , 'Opposuits Men Black suit':79.00 , 'Dirty white shorts':100 , 'Fake beard':1399.99 , 'Mens Wedding shirt':70.95}
...
tech5 = {'Meta Quest 2 Vr':399.99  , 'Acer Swift laptop':1099.99 , 'Flagship chromebook':94.99, 'Google pixel 6a':369.99 , 'Samsung Galaxy A10e':102.99 , 'Iphone 11pro':524.95 , 'Intel i7cpu':321.97 , 'Hp pavillio32':2399.99 , 'Lphone 10':5 , 'Samsung odyysey ark monitor':3499.99}
...
beauty7 = {'red lipstick':7 , 'BlueLipstick':5 , 'orangeLipstick':4 , 'pinkLipstick':7 , 'Mascara':20 , 'LashExtensions':15 , 'NoseSurgery':5000 , 'greenWig':25 , 'deoderant':2 , 'Shampoo':10} 
...
##### function from line 36 being used #####
while (cont == "y"): 
        store = checkpoint1()
