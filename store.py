...
def storeMeth():
    ...
    while (cont == "y"):
        ...
        if int(store) == 1:
            ...
            for item , value3 in mensClothes3.items():
                print(item , value3 )


        elif int(store) == 4:
            for item , value4 in womensClothes4.items():
                print(item , value4)


        elif int(store) == 5:
            for item , value5 in tech5.items():
                print(item , value5)

        elif int(store) == 6:
            for item , value6 in bakery6.items():
                print(item , value6)

        elif int(store) == 7:
            for item , value7 in beauty7.items():
                print(item ,value7)
