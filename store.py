...
frozenFood1 = ["El monterray burritoes-$5.19" , "Bibigo Mandu Dumplings-$10.49" , "Red Baron Pizza-6.99$" , "Hot Pockets(12pack)-$13.88" , "El monterray taquitos-$9.69" , "Boudin BALLS-$9.89" , "Members mark chiken BREAST-$15.98" , "Blue Bunny Ice cream-$4.48" , "MEGA MEAT BONELESS STRIP OF MEAT-$3.99" , "Mangonada de Hielo-$2.50"] 
...
mensClothes3 = ["Hennything is possible Tshirt-$19.99" , "Mens Summer games Cargo pants-$40.00" , "Nordstorm Trim fit Dress shirt-$59.50" , "Brown Jacket-$100.00" , "Nike Sportswear Fullzip hoodie-$130.00" , "Opposuits Men Black suit-$79.00" , "Dirty white shorts-$100" , "Fake beard-1,399.99" , "Mens Wedding shirt-$70.95"]
...
while (cont == "y"):
    ...
    if int(store) == 1:
        for item in frozenFood1:
            print(item)

    elif int(store) == 2:
        for item in cannedGoods2:
            print(item)
